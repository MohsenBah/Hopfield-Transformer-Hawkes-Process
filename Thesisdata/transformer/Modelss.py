...
class Hopfield(torch.nn.Module):
    ...
    def forward(self, event_time_pred, event_type_pred, xy_pred, attn1,attn2,attn3,attn4,attn5,attn6,attn7,attn8,enc1,enc2,enc3,enc4,enc5,enc6,enc7,enc8,non_pad_mask):
        ...
        output_pred = torch.cat((temporal_input_embedded[:,:-150,:], enc), dim=1)
...
class Transformer(nn.Module):
    ...
    def forward(self, event_type, event_time, xy,event_time_pred, event_type_pred, xy_pred,attn1,attn2,attn3,attn4,attn5,attn6,attn7,attn8,enc1,enc2,enc3,enc4,enc5,enc6,enc7,enc8):
        ...
        dec_output = self.decoder(event_time_pred, event_type_pred, xy_pred, attn1,attn2,attn3,attn4,attn5,attn6,attn7,attn8,enc1,enc2,enc3,enc4,enc5,enc6,enc7,enc8,non_pad_mask)
        ...
        time_prediction = self.time_predictor(outputs, non_pad_mask2)

        type_prediction = self.type_predictor(outputs, non_pad_mask2)

        return outputs, (type_prediction, time_prediction)
